...
author: "Alan R. Pearse, QUT Mathematics Society"
date: "19 March, 2019"
output: pdf_document
---
...
Let's say we are interested in the correlation between $\log(\text{zinc})$ concentrations in soil and distance away from the river. We expect it to decrease with distance because zinc is a heavy metal that settles quickly from the water column during floods. 
